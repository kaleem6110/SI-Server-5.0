...
<%
  ...
  RoleRightsMap roleRightsMap	= AccessHelper.getRoleRightsMap(userBean,PrivilegesConstants.SubRight.USR_GRP_PER_MAIN_USERS,moduleId);  
         ...
         function displaySearchFieldBasisDataType(dataType,id) {
            ...
            if(dataType=="string" || dataType=="number") {
              ...
              function clearSearch() {
                  ...
                  document.forms[0].action="./ModelPaginationUserAction.do";
...
<script>
 ...
 function createUser(){
		window.location = "userAction.do?operation=showCreateUser";
  }
...
function enableBtn(selectedObj, dsType){
       ...
       url ="<%=ServerUtils.getContextName(request)%>/userAction.do?operation=showUpdateUser&userId="+selectedObj.value;
       deleteUrl ="<%=ServerUtils.getContextName(request)%>/userAction.do?operation=delete&userId="+selectedObj.value;
...
function isAnyRowSelected(displayMessage,callfrom){
    if(rowSelected == 'no'){
        showEmptyDialog(displayMessage,'User');
        return false;
    }else{
        if(callfrom == 'update'){
            updateDS();
                              ...
                              <table cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td  class="pageTitle paddingTitle">      
                                         <bean:message key="admin.usrgrppermission.user.viewuser" bundle="admin"/>
                                    </td>
                                </tr>
       
                                <tr>
                                    <td  class="paddingTitleDesc bodytext">      
                                        <strong> <bean:message key="admin.usrgrppermission.user.description" bundle="admin"/> </strong>
                                    </td>
                                 </tr>
								 <tr>   
                    ...
                    <table>
                        <tbody>                        
      							...
      							<td height="30" valign="top" align="right">
            						<table class="htmlPagination">
                						<tr>
                                            ...
                                            <td valign="top"><input type="text" id="enteredPageNo" size="5" name="enteredPageNo" style="height:28;width:50; text-align:center; vertical-align:middle" autocomplete="off" onKeyPress="onEnterGoToPage();" value="<bean:write name="userForm" property="pageNo"/> of <bean:write name="userForm" property="totalNoOfPages"/>" disabled="true"/></td>
                            ...
                            %>
                                    ...
                                    <html:hidden name="userForm" property="compositeFiledNames" value="<%=(String)innnerList.get(0)%>"/>
                            <%          
                            ...
                            %>
                              ...
                              <tr  class="bgcolor" onMouseOver="hover(this);" onMouseOut="unHover(this, 1);" onDblClick="viewUser('<%=(innnerList.get(1))%>','<%=(innnerList.get(2))%>','<%=(innnerList.get(3))%>','<%=(innnerList.get(4))%>','<%=(innnerList.get(5))%>','<%=(innnerList.get(6))%>','<%=(innnerList.get(7))%>','<%=(innnerList.get(8))%>','<%=(innnerList.get(9))%>','<%=(innnerList.get(10))%>','<%=(innnerList.get(11))%>','<%=(innnerList.get(12))%>','<%=(innnerList.get(13))%>')">
                                    <td class="textnormal12" align="center" ><html:radio disabled="<%=disableAction%>"  property="selectedRecordId" name="userForm"  
                            ...
                            %>
							 ...
							 <html:hidden name="userForm" property="totalNoOfPages" styleId="totalNoOfPages"/>
                            <html:hidden name="userForm" property="pageNo" styleId="pageNo"/>
                            <html:hidden name="userForm" property="screenCategory"/>
                            </tr>
  ...
  <table width="101.2%" border=0 style="padding-top:20px" >
    <tr class="barColor">
      <td align="center">
        ...
        <button dojoType="dijit.form.Button"  <%if(!roleRightsMap.getHasCreateAccess()) { %> disabled="true" <%}%> type="button"  onclick="createUser()">
  ...
  <script>
    dojo.addOnLoad(loadFormValues); 
        function loadFormValues(){
                 if(<bean:write name="userForm" property="totalNoOfPages"/>  <= 1 && <bean:write name="userForm" property="pageNo"/> <= 1){
                ...
                }else if(<bean:write name="userForm" property="totalNoOfPages"/>  > 1 && <bean:write name="userForm" property="pageNo"/> <= 1){
                         document.getElementById('start_on').style.display='none';
                        document.getElementById('start_off').style.display='';
                        document.getElementById('previous_on').style.display='none';
                        document.getElementById('previous_off').style.display='';
                ...
                }else if(<bean:write name="userForm" property="totalNoOfPages"/>  > 1 && (<bean:write name="userForm" property="pageNo"/> > 1 && (<bean:write name="userForm" property="pageNo"/> != <bean:write name="userForm" property="totalNoOfPages"/>))){
                        ...
                        document.getElementById('end_on').style.display='';
                        document.getElementById('end_off').style.display='none';
                }else if((<bean:write name="userForm" property="totalNoOfPages"/>  > 1) && (<bean:write name="userForm" property="pageNo"/> == <bean:write name="userForm" property="totalNoOfPages"/>)){                     
                        document.getElementById('start_on').style.display='';
                        document.getElementById('start_off').style.display='none';
                        document.getElementById('previous_on').style.display='';
                        document.getElementById('previous_off').style.display='none';
	...
	function viewUser(loginId,firstName,lastName,email,phoneNumber,active,organization,firstStreet,secondStreet,city,state,country,zipcode){
		
	innerData = '<br><fieldset style="width: 100%"><legend class="bigtext"><strong><bean:message key="admin.usrgrppermission.user.propertywindow.properties" bundle="admin"/></strong></legend> <table cellspacing="5" cellPadding="3" ><tr><td style="padding-left:20px" class="textnormal12" ><strong><bean:message key='admin.usrgrppermission.user.label.loginid' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td align="left" class="textnormal12">'+loginId+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.firstname' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+firstName+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.lastname' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+lastName+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.email' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+email+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.phoneno' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+phoneNumber+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.active' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+active+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.organization' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+organization+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.firststreet' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+firstStreet+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.secondstreet' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+secondStreet+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.city' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+city+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.state' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+state+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.country' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+country+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.usrgrppermission.user.label.zipcode' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+zipcode+'</td></tr></table></fieldset>';
		openInfoframe(innerData,'<bean:message key="admin.usrgrppermission.module.propertywindow.user" bundle="admin"/>',200);
}
