...
<%
  ...
  String modulePrefMapId      =(String) session.getAttribute(ServerUtils.PARAM_MODULE_ID);
  //Get the access permissions for the given right or subright and accessType                         
  RoleRightsMap roleRightsMap	= AccessHelper.getRoleRightsMap(userBean,PrivilegesConstants.SubRight.MODEL_MAIN_CONFIG_MOD_CAT_MAP,modulePrefMapId);  
         ...
         function displaySearchFieldBasisDataType(dataType,id) {
            ...
            if(dataType=="string" || dataType=="number") {
              ...
              function clearSearch() {
                  ...
                  document.forms[0].action="./ModelPaginationModulePrefMappingAction.do";
...
<script>
  ...
  function createModule(){
	window.location = "userPreferencesConfigAction.do?operation=showCreateModulePrefMapping";
  }
function updateModule(){

	window.location = "userPreferencesConfigAction.do?operation=showUpdateModulePrefMapping&param1=update";
  }
  function deleteModule(){
	window.location = "userPreferencesConfigAction.do?operation=showUpdateDeleteModule&param1=delete";
  }
...
function enableBtn(selectedObj, dsType){
       document.getElementById('modulePrefMapId').value = selectedObj.value;
       url ="<%=ServerUtils.getContextName(request)%>/userPreferencesConfigAction.do?operation=showUpdateModulePrefMapping&modulePrefMapId="+selectedObj.value;
       deleteUrl ="<%=ServerUtils.getContextName(request)%>/userPreferencesConfigAction.do?operation=deleteModulePrefMapping&modulePrefMapId="+selectedObj.value;
...
function isAnyRowSelected(displayMessage,callfrom){
    if(rowSelected == 'no'){
        showEmptyDialog(displayMessage,'Module Preferences Mapping');
        return false;
    }else{
        if(callfrom == 'update'){
            updateDS();
...
<body class="tundra bodybg"  >
 <html:form action="userPreferencesConfigAction"  method="POST">
  <input type="hidden" name="modulePrefMapId" id="modulePrefMapId" />
                              ...
                              <table cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td  class="pageTitle paddingTitle">      
                                         <bean:message key="admin.configuration.moduleprefcat.viewtitle" bundle="admin"/>
                                    </td>
                                </tr>
       
                                <tr>
                                    <td  class="paddingTitleDesc bodytext">      
                                        <strong> <bean:message key="admin.configuration.moduleprefcat.viewdesc" bundle="admin"/> </strong>
                                    </td>
                                 </tr>
								 <tr>   
                    ...
                    <table>
                        <tbody>                        
      							...
      							<td height="30" valign="top" align="right">
            						<table class="htmlPagination">
                						<tr>
                                            ...
                                            <td valign="top"><input type="text" id="enteredPageNo" size="5" name="enteredPageNo" style="height:28;width:50; text-align:center; vertical-align:middle" autocomplete="off" onKeyPress="onEnterGoToPage();" value="<bean:write name="modulePrefMappingForm" property="pageNo"/> of <bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>" disabled="true"/></td>
                            ...
                            %>
                                    ...
                                    <html:hidden name="modulePrefMappingForm" property="compositeFiledNames" value="<%=(String)innnerList.get(0)%>"/>
                            <%          
                            ...
                            %>
                              ...
                              <tr  class="bgcolor" onMouseOver="hover(this);" onMouseOut="unHover(this, 1);" onDblClick="viewModule('<%=(innnerList.get(1))%>','<%=(innnerList.get(2))%>','<%=(innnerList.get(3))%>','<%=(innnerList.get(4))%>')">
                                    <td class="textnormal12" align="center" ><html:radio disabled="<%=disableAction%>"  property="selectedRecordId" name="modulePrefMappingForm"  
                            ...
                            %>
							 ...
							 <html:hidden name="modulePrefMappingForm" property="totalNoOfPages" styleId="totalNoOfPages"/>
                            <html:hidden name="modulePrefMappingForm" property="pageNo" styleId="pageNo"/>
                            <html:hidden name="modulePrefMappingForm" property="screenCategory"/>
                            </tr>
  ...
  <script>
    dojo.addOnLoad(loadFormValues); 
        function loadFormValues(){
                 if(<bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>  <= 1 && <bean:write name="modulePrefMappingForm" property="pageNo"/> <= 1){
                ...
                }else if(<bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>  > 1 && <bean:write name="modulePrefMappingForm" property="pageNo"/> <= 1){
                         document.getElementById('start_on').style.display='none';
                        document.getElementById('start_off').style.display='';
                        document.getElementById('previous_on').style.display='none';
                        document.getElementById('previous_off').style.display='';
                ...
                }else if(<bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>  > 1 && (<bean:write name="modulePrefMappingForm" property="pageNo"/> > 1 && (<bean:write name="modulePrefMappingForm" property="pageNo"/> != <bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>))){
                        ...
                        document.getElementById('end_on').style.display='';
                        document.getElementById('end_off').style.display='none';
                }else if((<bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>  > 1) && (<bean:write name="modulePrefMappingForm" property="pageNo"/> == <bean:write name="modulePrefMappingForm" property="totalNoOfPages"/>)){                     
                        document.getElementById('start_on').style.display='';
                        document.getElementById('start_off').style.display='none';
                        document.getElementById('previous_on').style.display='';
                        document.getElementById('previous_off').style.display='none';
		...
		function viewModule(moduleName,moduleDescription,moduleUrl,isMobileModule){
			innerData = '<br><fieldset style="width: 100%"><legend class="bigtext"><strong><bean:message key="admin.configuration.moduleprefcat.property.desc" bundle="admin"/></strong></legend> <table cellspacing="5" cellPadding="3" ><tr><td style="padding-left:20px" class="textnormal12" ><strong><bean:message key='admin.configuration.moduleprefcat.moduleurlid.label' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td align="left" class="textnormal12">'+moduleName+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.configuration.moduleprefcat.displayname.label' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+moduleDescription+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.configuration.moduleprefcat.url.label' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+moduleUrl+'</td></tr><tr><td style="padding-left:20px" class="textnormal12"><strong><bean:message key='admin.configuration.moduleprefcat.displayorder.label' bundle='admin'/></strong></td><td><strong>&nbsp;&nbsp;:&nbsp;</strong></td><td class="textnormal12" align="left">'+isMobileModule+'</td></tr></table></fieldset>';
			openInfoframe(innerData,'<bean:message key="admin.configuration.moduleprefcat.property.title" bundle="admin"/>',200);
		}   
