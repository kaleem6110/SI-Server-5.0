...
<%  
   String configNames= "layout:PREF_USER_DASHBOARD_DASHBOARD_LAYOUT#PREF_MODULE_DASHBOARD_DASHBOARD_LAYOUT,numberOfColumns:PREF_USER_DASHBOARD_DASHBOARD_NUMBEROFCOLUMNS#PREF_MODULE_DASHBOARD_DASHBOARD_NUMBEROFCOLUMNS,numberOfRows:PREF_USER_DASHBOARD_DASHBOARD_NUMBEROFROWS#PREF_MODULE_DASHBOARD_DASHBOARD_NUMBEROFROWS,defaultWidth:PREF_USER_DASHBOARD_DASHBOARD_DEFAULTWIDTH#PREF_MODULE_DASHBOARD_DASHBOARD_DEFAULTWIDTH,defaultHeight:PREF_USER_DASHBOARD_DASHBOARD_DEFAULTHEIGHT#PREF_MODULE_DASHBOARD_DASHBOARD_DEFAULTHEIGHT";
        ...
        <legend class="fieldsetlegend"><strong><bean:message key="preferences.layout" bundle="admin"/></strong></legend>
            <table cellspacing="5" >
                <tr>
                    ...
                    <td width="60" title='<bean:message key="preferences.dashboard.dashboard.layout.tooltip" bundle="admin"/>'>
                            ...
                            <legend class="fieldsetlegend"><strong><bean:message key="preferences.dimensions" bundle="admin"/></strong></legend>
                                <table cellspacing="5" >
                                    <tr>
                                        ...
                                        <td width="60" title='<bean:message key="preferences.dashboard.dashboard.numberofrows.tooltip" bundle="admin"/>'>
                                        ...
                                        <td width="60" title='<bean:message key="preferences.dashboard.dashboard.numberofcolumns.tooltip" bundle="admin"/>'>
                                    ...
                                    <tr>
                                        ...
                                        <td width="60" title='<bean:message key="preferences.dashboard.dashboard.defaultwidth.tooltip" bundle="admin"/>'>
                                        ...
                                        <td width="60" title='<bean:message key="preferences.dashboard.dashboard.defaultheight.tooltip" bundle="admin"/>'>
