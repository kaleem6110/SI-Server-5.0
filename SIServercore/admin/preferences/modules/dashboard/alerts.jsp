...
<%  
   String configNames= "snoozeTime:PREF_USER_DASHBOARD_ALERT_SNOOZETIME#PREF_MODULE_DASHBOARD_ALERT_SNOOZETIME,snoozeTimeUnits:PREF_USER_DASHBOARD_ALERT_SNOOZETIME#PREF_MODULE_DASHBOARD_ALERT_SNOOZETIME,audioFile:PREF_USER_DASHBOARD_ALERT_AUDIOFILE#PREF_MODULE_DASHBOARD_ALERT_AUDIOFILE,noOfMessages:PREF_USER_DASHBOARD_ALERT_NOOFMESSAGES#PREF_MODULE_DASHBOARD_ALERT_NOOFMESSAGES,enableAlarm:PREF_USER_DASHBOARD_ALERT_ENABLEALARM#PREF_MODULE_DASHBOARD_ALERT_ENABLEALARM,tickerOffset:PREF_USER_DASHBOARD_ALERT_TICKEROFFSET#PREF_MODULE_DASHBOARD_ALERT_TICKEROFFSET,messageScrollCount:PREF_USER_DASHBOARD_ALERT_MESSAGESCROLLCOUNT#PREF_MODULE_DASHBOARD_ALERT_MESSAGESCROLLCOUNT,messageScrollSpeed:PREF_USER_DASHBOARD_ALERT_MESSAGESCROLLSPEED#PREF_MODULE_DASHBOARD_ALERT_MESSAGESCROLLSPEED";
...
<UserPreferences:UserPreferences userId="<%=ESAPI.encoder().encodeForHTML(userId)%>" moduleId="<%=ESAPI.encoder().encodeForHTML(moduleId)%>"  categoryName="<%=ESAPI.encoder().encodeForHTML(categoryName)%>" configNames="<%=ESAPI.encoder().encodeForHTML(configNames)%>"  importType="<%=ESAPI.encoder().encodeForHTML(importType)%>"/>
 ...
 <input type="hidden" name="categoryName" value="<%=ESAPI.encoder().encodeForHTML(categoryName)%>"/>
    ...
    <table cellspacing="5" style="margin-left:10px;">
            ...
            <tr>
                    ...
                    <td align="left" title='<bean:message key="preferences.dashboard.alerts.snoozetime.tooltip" bundle="admin"/>'>
 ...
 constraints="{min:0,max:999,places:0}" style="width:70px;" value='<%=ESAPI.encoder().encodeForHTML("".equals((String)pageContext.getAttribute("snoozeTime")) || pageContext.getAttribute("snoozeTime") == null ?"20":(String)pageContext.getAttribute("snoozeTime"))%>' <%=ESAPI.encoder().encodeForHTML((pageContext.getAttribute("snoozeTime_update")!=null)?"disabled=\"disabled\"":"") %> >
                    ...
                    <td align="left" title='<bean:message key="preferences.dashboard.alerts.snoozetimeunits.tooltip" bundle="admin"/>'>
            ...
            <tr>
                ...
                <td align="left" title='<bean:message key="preferences.dashboard.alerts.noofmessages.tooltip" bundle="admin"/>'>
        ...
        <legend class="fieldsetlegend"><strong><bean:message key="preferences.alarm" bundle="admin"/></strong></legend>
            <table cellspacing="5" >
                <tr>
                    ...
                    <td width="70" title='<bean:message key="preferences.dashboard.alerts.enablealarm.tooltip" bundle="admin"/>'><input type="checkbox" name="enableAlarm" <%= (("on".equals(pageContext.getAttribute("enableAlarm")))||("".equals(pageContext.getAttribute("enableAlarm"))))?"checked":""%>  <%=(pageContext.getAttribute("enableAlarm_update")!=null)?"disabled=\"disabled\"":"" %>/>&nbsp;<strong><bean:message key="preferences.enable" bundle="admin"/></strong>
                    </td>
                
                    <td width="20">&nbsp;</td>
                    <td align="right" width="110"><strong><bean:message key="preferences.audio.file" bundle="admin"/></strong>:</td>
                    <td title='<bean:message key="preferences.ge.alerts.audiofile.tooltip" bundle="admin"/>'><select name="audioFile" style="width:200px" id="audioFile" value=""  dojoType="dijit.form.FilteringSelect" <%=(pageContext.getAttribute("audioFile_update")!=null)?"disabled=\"disabled\"":"" %>>
        ...
        <legend class="fieldsetlegend"><strong><bean:message key="preferences.ticker" bundle="admin"/></strong></legend>
            <table cellspacing="5" >
                <tr>
                    ...
                    <td width="60" title='<bean:message key="preferences.dashboard.alerts.tickeroffset.tooltip" bundle="admin"/>'><input size="3" type="text" name="tickerOffset" dojoType="dijit.form.NumberSpinner" required='true' invalidMessage="<bean:message key="admin.invalid.error" bundle="admin" />" 
        ...
        <legend class="fieldsetlegend"><strong><bean:message key="preferences.message.scroll" bundle="admin"/></strong></legend>
            <table cellspacing="5">
                <tr>
                    ...
                    <td width="60" title='<bean:message key="preferences.dashboard.alerts.messagescrollcount.tooltip" bundle="admin"/>'><input size="3" type="text" name="messageScrollCount" dojoType="dijit.form.NumberSpinner" invalidMessage="<bean:message key="admin.invalid.error" bundle="admin" />" required='true'
 constraints="{min:0,max:999,places:0}" style="width:70px;" value='<%=ESAPI.encoder().encodeForHTML((String)pageContext.getAttribute("messageScrollCount"))%>' <%=(pageContext.getAttribute("messageScrollCount_update")!=null)?"disabled=\"disabled\"":"" %>></td>
                    ...
                    <td title='<bean:message key="preferences.dashboard.alerts.messagescrollspeed.tooltip" bundle="admin"/>'><input size="3" type="text" name="messageScrollSpeed" dojoType="dijit.form.NumberSpinner" required='false'
