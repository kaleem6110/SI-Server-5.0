...
<html:form action="masterTableRecordHistoryAction.do" method="POST">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <table cellSpacing="5" cellPadding="3" >
                                    <nested:iterate name="masterTableRecordHistoryForm" property="fieldValueBeanList" id="codeId" indexId="rowId">
                                        <tr>
