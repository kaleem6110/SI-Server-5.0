...
<html:form action="masterTableRecordRestoreAction.do" method="POST">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <table cellSpacing="5" cellPadding="3" >
                                    <nested:iterate name="masterTableRecordRestoreForm" property="fieldValueBeanList" id="codeId" indexId="rowId">
                                        <tr>
