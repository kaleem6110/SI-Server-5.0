...
com.enterprisehorizons.magma.jobs.forms.FileCleanUpTimerForm,
...
<%FileCleanUpTimerForm formObj = (FileCleanUpTimerForm)request.getAttribute("fileCleanUpTimerForm");%>
...
<html:form action="/fileCleanUpTimerAction.do?operation=onUpdateFileCleanTimer" method="POST">
<table width="100%">
	<tr>
		<td width="100%">
				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							<html:hidden  property="id" name="fileCleanupTimerForm"  />
							<tr>
                            ...
                            <tr>
                                ...
                                <td align="left"><input type="text"  id="jobName" name="jobName"  class="medium1" style="height:1.7em;" maxlength="45" autocomplete="off" dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true"  value='<bean:write name="fileCleanupTimerForm" property="jobName" />' />   </td>
                                <td width="30">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" align="left"><textarea dojoType="dijit.form.SimpleTextarea" rows="5" cols="30" id="description" class="medium1" style="height:5.7em;" name="description"  ><bean:write name="fileCleanupTimerForm" property="description" /></textarea></td>
                                <td width="30">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                	 <div id="startTimeDiv" style="width:194px;height:1.7em;">
																<input type="text"   id="startTime" name="startTime" class="medium1" autocomplete="off" style="height:1.7em;" dojoType="dijit.form.ValidationTextBox"   invalidMessage="Invalid time. Use HH:mm:ss where HH is 00 - 23 hours."/><font size="1">&nbsp;<label><bean:message key="jobs.startTimeFormat" bundle="jobs"/></label></font>
															</div>
                                </td>
                          	</tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                		<select  id="jobType" dojoType="dijit.form.FilteringSelect"name="jobType" autocomplete="off" onChange="javascript:statusChange();" value="<bean:write name="fileCleanupTimerForm" property="jobType" />">
                            ...
                            <tr>
                                ...
                                <td align="left"><html:checkbox  name="fileCleanupTimerForm" property="commonJobFlag" onclick="checkBoxAlert(this);" disabled="<%=checkboxstatus%>"></html:checkbox></td>
                                <td >&nbsp;</td>
                                <td align="right" style="padding-right:5px">&nbsp;</td>
                                <td align="left">&nbsp;</td>
                          	</tr>
								...
								<td>
									<table width="auto" cellpadding="0" cellspacing="0" align="left" border="0">
										<tr>
											...
											<td>
												<select  id="intervalType" dojoType="dijit.form.FilteringSelect"  name="intervalType" autocomplete="off"   onChange="return setFocus();" value='<bean:write name="fileCleanupTimerForm" property="intervalType" />'>
													<option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
											...
											<td id="absoluteIntervalDailyDIVLabelDtls" style="display:none">
												<table border="0" width="auto">
													<tr>
														...
														<td>
															<input type="text"  id="absoluteDailyInterval" name="absoluteDailyInterval" style="height:1.7em;width:100px;" dojoType="dijit.form.ValidationTextBox" autocomplete="off" maxlength="2" onkeyup="return setdailyFocus();"/> <label><b><bean:message key="jobs.recur.daysLabel" bundle="jobs"/></b></label>
														</td>
													</tr>
													
													<tr>
														<td colspan="2">
															<input onClick="resetAbsoluteDailyPatternFormValues()" type="radio" dojoType="dijit.form.RadioButton" autocomplete="off" name="absoluteDailyPattern" id="absoluteDailyPatternEveryWeekDay" autocomplete="off" value="selectedAbsoluteDailyPatternEveryWeekDay" /><label><b><bean:message key="jobs.recur.weekdaysLabel" bundle="jobs"/></b></label>
														</td>                               
													</tr>
												</table>
											</td>
				...
				<tr>
					<td style="padding-left:67px;">
						<div id="div4" style="display:block;">
							<table class="tableBgColor" width="65%">
								<tr height="10px">
									<td>&nbsp;
									</td>
								</tr>
								...
								<tr>
								   <td class="paddingTitleDesc;align:left;" style="padding-left:30px;align:left;">
										 <bean:message key="jobs.fileCleanup.description" bundle="jobs"/>
									</td>  
								</tr>
								<tr>
									<td height="13">
											...
											<tr>
												<td>
													...
													<table cellpadding="0" cellspacing="0" border="0" width="100%">
														<tr>
															<td height="27" style="padding-right:3px;" align="right" nowrap="nowrap" width="18%">
																<label class="label"><bean:message key="jobs.directory" bundle="jobs"/></label><label class="error">*</label><b>:</b>
															</td>
															<td style="align:left;padding-left:2px" width="26%">
																<input type="text"  id="directory" name="directory" class="medium" style="height:1.7em;" autocomplete="off" dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true" value="<bean:write name="fileCleanupTimerForm" property="directory"/>" />   
															</td>
															
															<td height="27" align="right" width="14%"style="padding-right:3px;">
																<label class="label"><bean:message key="jobs.fileTypes" bundle="jobs"/></label><label class="error">*</label><b>:</b>
															</td>  
															
															<td style="align:left;padding-left:2px;" width="24%">  
																<input type="text"  id="selectedFileType"  name="selectedFileType" style="height:1.7em;" autocomplete="off" dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true" value="<bean:write name="fileCleanupTimerForm" property="selectedFileType"/>"   />  
															</td>
													...
													<table cellpadding="0" cellspacing="" border="0" width="100%">
														<tr>
															<td height="27" style="padding-right:3px;" align="right" nowrap="nowrap" width="18%">
																		...
																		<td height="27" style="align:left;padding-left:2px" width="26%">
																			<html:checkbox  name="fileCleanupTimerForm" property="includeSubdirectories" disabled="<%=readOnly%>"></html:checkbox>                
																		</td>
																		...
																		<td height="27" style="padding-left:2px; align:left;" width="42%" >  
																			<input type="text" id="noOfDaysOld" name="noOfDaysOld"  autocomplete="off" dojoType="dijit.form.NumberTextBox" constraints="{min:0,max:365,places:0}" style="height:1.7em;" invalidMessage="The value entered is invalid" value="<bean:write name="fileCleanupTimerForm" property="noOfDaysOld"/>" />
																		</td>
								...
								<td style="padding-left:30px;">
									...
									<%if (taskCount == -1 || taskCount == 0) {%>
										...
										<tr id="row1">			
												...
												<td>
												<select  id="availableTaskRunType1"    dojoType="dijit.form.FilteringSelect"  name="availableTaskRunType1"    autocomplete="off"   value='<bean:write name="fileCleanupTimerForm" property="availableTaskRunType1" />'
												...
												<td>
												<select  id="availableTaskType1"    dojoType="dijit.form.FilteringSelect"  name="availableTaskType1"    autocomplete="off"   value='<bean:write name="fileCleanupTimerForm" property="availableTaskType1" />'
												<%if (readOnly) {%> disabled=true <%}%>>
													<option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
...
resetViewSimpleTriggerNote('none');  
    ...
    dojo.byId('startTime').setAttribute('value', '<bean:write name="fileCleanupTimerForm" property="startTime" />');
    dijit.byId('startDate').setDisplayedValue('<bean:write name="fileCleanupTimerForm" property="startDate" />');        
    document.getElementById('startTime').value= '<bean:write name="fileCleanupTimerForm" property="startTime" />';
    document.getElementById('startDate').value= '<bean:write name="fileCleanupTimerForm" property="startDate" />';
    dijit.byId('description').setAttribute('disabled', status); 
    dijit.byId('startTimeType').setAttribute('disabled', true);   
	dijit.byId('startTimeType').setValue('<bean:write name="fileCleanupTimerForm" property="startTimeType" />'); 
	if(dijit.byId('startTimeType').value == START_JOB_AFTER_SERVER_START){
		if('<bean:write name="fileCleanupTimerForm" property="afterServerStartsPattern" />' == 'EVERY'){
		...
		}else if('<bean:write name="fileCleanupTimerForm" property="afterServerStartsPattern" />' == 'ONCE'){
			dijit.byId('afterServerStartsPatternOnce').setAttribute('disabled',status);
			dijit.byId('afterServerStartsPatternEvery').setAttribute('disabled',status);
		...
		dijit.byId('cronTypeId').setValue('<bean:write name="fileCleanupTimerForm" property="cronTypeId" />');
		dijit.byId('absoluteInterval').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteInterval" />');
		dijit.byId('cronTypeId').setAttribute('disabled', status);
		dijit.byId('absoluteInterval').setAttribute('disabled', status);
		populateAbsoluteStartTypeValues('<bean:write name="fileCleanupTimerForm" property="cronTypeId" />', status);
	}else if(dijit.byId('startTimeType').value == START_JOB_EXPRESSION){
			dijit.byId('expression').setValue('<bean:write name="fileCleanupTimerForm" property="expression" />');
			dijit.byId('expression').setAttribute('disabled', status);
	}
	dojo.byId('interval').value = '<bean:write name="fileCleanupTimerForm" property="interval" />';
//	dijit.byId('intervalType').setValue('<bean:write name="fileCleanupTimerForm" property="intervalType" />');
    ...
    dijit.byId('noOfDaysOld').setAttribute('disabled', status); 
    ...
    try{
		dijit.byId('selectedFileType').setAttribute('disabled', status);    
	}catch(er){
	}
    try{
		dijit.byId('directory').setAttribute('disabled', status);   
    }catch(er){
	}
	...
	dijit.byId('listener').setValue('<bean:write name="fileCleanupTimerForm" property="listener" />');
	dijit.byId('isTask').setAttribute('disabled', true);
	if('<bean:write name="fileCleanupTimerForm" property="isTask" />' == 'Y') {
	...
	if('<bean:write name="fileCleanupTimerForm" property="isTaskPresent" />' == 'Y') {
...
function populateAbsoluteStartTypeValues(cronTypeId, status){
	if(cronTypeId == REPEAT_TRIGGER_IN_DAILY){
		if('<bean:write name="fileCleanupTimerForm" property="absoluteDailyPattern" />' == 'selectedAbsoluteDailyPatternEveryDay'){
			dijit.byId('absoluteDailyPatternEveryDay').setAttribute('checked',true);
			dijit.byId('absoluteDailyInterval').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteDailyInterval" />');
			dijit.byId('absoluteDailyPatternEveryWeekDay').setAttribute('disabled',status);
			dijit.byId('absoluteDailyInterval').setAttribute('disabled',status);
			resetViewSimpleTriggerNote('');
		}else if('<bean:write name="fileCleanupTimerForm" property="absoluteDailyPattern" />' == 'selectedAbsoluteDailyPatternEveryWeekDay'){
	...
	if(cronTypeId == REPEAT_TRIGGER_IN_WEEKLY){
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternSunday" />' == 'absoluteWeeklyPatternSunday'){
			dijit.byId('absoluteWeeklyPatternSunday').setAttribute('checked',true);				
		}
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternMonday" />' == 'absoluteWeeklyPatternMonday'){
			dijit.byId('absoluteWeeklyPatternMonday').setAttribute('checked',true);				
		}
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternTuesday" />' == 'absoluteWeeklyPatternTuesday'){
			dijit.byId('absoluteWeeklyPatternTuesday').setAttribute('checked',true);			
		}
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternWednesday" />' == 'absoluteWeeklyPatternWednesday'){
			dijit.byId('absoluteWeeklyPatternWednesday').setAttribute('checked',true);
		}
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternThursday" />' == 'absoluteWeeklyPatternThursday'){
			dijit.byId('absoluteWeeklyPatternThursday').setAttribute('checked',true);			
		}
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternFriday" />' == 'absoluteWeeklyPatternFriday'){
			dijit.byId('absoluteWeeklyPatternFriday').setAttribute('checked',true);				
		}
		if('<bean:write name="fileCleanupTimerForm" property="absoluteWeeklyPatternSaturday" />' == 'absoluteWeeklyPatternSaturday'){
	...
	if(cronTypeId == REPEAT_TRIGGER_IN_MONTHLY){
		if('<bean:write name="fileCleanupTimerForm" property="absoluteMonthlyPattern" />' == 'selectedAbsoluteMonthlyPatternEveryDay'){
			dijit.byId('absoluteMonthlyPatternEveryDay').setAttribute('checked',true);
			dijit.byId('absoluteMonthlyDayInterval').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteMonthlyDayInterval" />');
		...
		}else if('<bean:write name="fileCleanupTimerForm" property="absoluteMonthlyPattern" />' == 'selectedAbsoluteMonthlyPatternEveryMonth'){
			dijit.byId('absoluteMonthlyPatternEveryMonth').setAttribute('checked',true);		
			dijit.byId('absoluteMonthlyWeekType').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteMonthlyWeekType" />');
			dijit.byId('absoluteMonthlyDayType').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteMonthlyDayType" />');
	...
	if(cronTypeId == REPEAT_TRIGGER_IN_YEARLY){
		if('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyPattern" />' == 'selectedAbsoluteYearlyPattern'){
			dijit.byId('absoluteYearlyPatternEveryMonth').setAttribute('checked',true);
			dijit.byId('absoluteYearlyMonthType').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyMonthType" />');
			dijit.byId('absoluteYearlyDayInterval').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyDayInterval" />');
		...
		}else if('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyPattern" />' == 'selectedAbsoluteYearlyPatternEveryMonthDay'){
			dijit.byId('absoluteYearlyPatternEveryMonthDay').setAttribute('checked',true);		
			dijit.byId('absoluteYearlyMonthlyWeekType').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyMonthlyWeekType" />');
			dijit.byId('absoluteYearlyMonthlyDayType').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyMonthlyDayType" />');
			dijit.byId('absoluteYearlyMonthlyMonthType').setValue('<bean:write name="fileCleanupTimerForm" property="absoluteYearlyMonthlyMonthType" />');
...
function resetValues(){	 
	window.location.href="<%=ServerUtils.getContextName(request)%>/configureJobSchdAction.do?operation=view&action=edit&jobsType=<%=String.valueOf(JobConstants.JOB_TYPE_FILECLEANUP)%>&selFileCleanUpTimer=<bean:write name="fileCleanupTimerForm" property="id"/>"; 
}
