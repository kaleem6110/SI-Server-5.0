...
com.enterprisehorizons.magma.jobs.forms.ClearCacheJobForm,
...
<html:form action="clearcacheAction.do?operation=onUpdateClearCached" method="post">
<table width="100%">
	<tr>
		<td width="100%">
					...
					<td style="padding-left:67px;align:left;">
						<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                ...
                                <td align="left"><input type="text"  id="jobName" name="jobName"  class="medium1" style="height:1.7em;" maxlength="45" autocomplete="off"	dojoType="dijit.form.ValidationTextBox" required="true" trim="true" ucfirst="true"  value="<bean:write name="clearCacheJobForm" property="jobName" />" />   </td>
                                <td width="30">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" align="left"><textarea dojoType="dijit.form.SimpleTextarea" rows="5" cols="30" id="description" class="medium1" style="height:5.7em;" name="description"  ><bean:write name="clearCacheJobForm" property="description" /></textarea></td>
                                <td width="30">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                		<select  id="jobType" dojoType="dijit.form.FilteringSelect"name="jobType" autocomplete="off" onChange="javascript:statusChange();" value="<bean:write name="clearCacheJobForm" property="jobType" />">
                            ...
                            <tr>
                                ...
                                <td align="left"><html:checkbox  name="clearCacheJobForm" property="commonJobFlag" onclick="checkBoxAlert(this);" disabled="<%=checkboxstatus%>"></html:checkbox></td>
                                <td >&nbsp;</td>
                                <td align="right" style="padding-right:5px">&nbsp;</td>
                                <td align="left">&nbsp;</td>
                          	</tr>
					...
					<td>
						<table width="auto" cellpadding="0" cellspacing="0" align="left" border="0">
							<tr>
								...
								<td>
									<input type="text"   id="interval" name="interval" style="width:100px;height:1.7em" dojoType="dijit.form.ValidationTextBox" autocomplete="off" required="false" invalidMessage="Invalid Number" maxlength="10" onkeyup="return setFocus();"/>
								</td>

								<td>
									<select  id="intervalType" dojoType="dijit.form.FilteringSelect"  name="intervalType" autocomplete="off"   onChange="return setFocus();" value='<bean:write name="clearCacheJobForm" property="intervalType" />'>
										<option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
										...
										<td style="align:left;">
											<table cellspacing="0" cellpadding="0" border="0" align="left" >
												<tr>
															...
															<table cellpadding="0" cellspacing="" border="0" >
																<tr>
																	...
																	<td style="align:left;" width="110px">
																			<select id="combobox1"   dojoType="dijit.form.MultiSelect" multiple name="combobox1" size="10" autocomplete="off"  ondblclick="return MoveItems('R', 0);" style="width:240px;">
													...
													<td>
															<select id="combobox2"   dojoType="dijit.form.MultiSelect" multiple name="combobox2" size="10" autocomplete="off"  ondblclick="return MoveItems('L', 0);" style="width:240px;">
								...
								<td style="padding-left:30px;">
									...
									<%if (taskCount == -1 || taskCount == 0) {%>
										<script>addedDependentTasksNumbers = '1,';</script>
											<tr>
												...
												<td>
												<select  id="availableTaskRunType1"    dojoType="dijit.form.FilteringSelect"  name="availableTaskRunType1"    autocomplete="off"   value='<bean:write name="clearCacheJobForm" property="availableTaskRunType1" />'
												...
												<td>
												<select  id="availableTaskType1"    dojoType="dijit.form.FilteringSelect"  name="availableTaskType1"    autocomplete="off"   value='<bean:write name="clearCacheJobForm" property="availableTaskType1" />'
												<%if (readOnly) {%> disabled=true <%}%>>
													<option value=""><bean:message key="validation.msg.select" bundle="splchvalidation"/></option>
									...
									<% } else {
										...
										<tr>
											...
											<td>
												<textarea dojoType="dijit.form.SimpleTextarea" rows="5" cols="30" id="availableTaskParamMap<%=suffixInt%>" style="height:1.7em;width:20em" name="availableTaskParamMap<%=suffixInt%>" <%if (readOnly) {%> disabled=true <%}%>><%=ESAPI.encoder().encodeForHTML(taskParam)%>
												</textarea>
											</td>
											<td>	
												<%if (!readOnly) {%>
...
resetViewSimpleTriggerNote('none');  
	...
	if(dijit.byId('startTimeType').value == START_JOB_AFTER_SERVER_START){
		...
		populateAbsoluteStartTypeValues('<bean:write name="clearCacheJobForm" property="cronTypeId" />', status);
			...
			dijit.byId('expression').setValue('<bean:write name="clearCacheJobForm" property="expression" />');
...
//	dijit.byId('intervalType').setValue('<bean:write name="clearCacheJobForm" property="intervalType" />');
	...
	dijit.byId('listener').setValue('<bean:write name="clearCacheJobForm" property="listener" />');
	dijit.byId('isTask').setAttribute('disabled', true);
	if('<bean:write name="clearCacheJobForm" property="isTask" />' == 'Y') {
	...
	if('<bean:write name="clearCacheJobForm" property="isTaskPresent" />' == 'Y') {
