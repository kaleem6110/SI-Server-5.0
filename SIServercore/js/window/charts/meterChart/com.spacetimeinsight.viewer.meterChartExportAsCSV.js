...
define([
	...
	$.widget('spacetimeinsight.siMeterChartExportAsCSV',$.spacetimeinsight.siViewerExportViewer,{
		options : {
		downloadDisabledSeries : false,
		downloadDisabledColumn : false,		
		},
		pluginName:"siMeterChartExportAsCSV",
		...
		_initialize : function(){
			...
			var seriesDetails = window.opener.parent.$si.viewer.meterChartColumnDetails;
