...
define([
	...
	$.widget('spacetimeinsight.siRadarChartExportAsCSV',$.spacetimeinsight.siViewerExportViewer,{
		options : {
		downloadDisabledSeries : false,
		downloadDisabledColumn : false,		
		},
		pluginName:"siRadarChartExportAsCSV",
		...
		_initialize : function(){
			...
			var seriesDetails = window.opener.parent.$si.viewer.radarChartColumnDetails;
