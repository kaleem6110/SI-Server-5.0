...
public class Severity implements java.io.Serializable {
    ...
    // Constructor
    protected Severity(java.lang.String value) {
        _value_ = value;
    ...
    public static final Severity NONE = new Severity(_NONE);
    public static final Severity NORMAL = new Severity(_NORMAL);
    public static final Severity UNDEFINED = new Severity(_UNDEFINED);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Severity.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/15.x", "severity"));
    }
    /**
