...
public class ProbeRange  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.sensor.client._15_x.ProbeValue[] val;
    ...
    public ProbeRange(
           int missingValues,
           lu.hitec.pss.soap.sensor.client._15_x.ProbeValue[] val) {
    ...
    /**
     * Gets the val value for this ProbeRange.
     * 
     * @return val
     */
    public lu.hitec.pss.soap.sensor.client._15_x.ProbeValue[] getVal() {
        return val;
    }


    /**
     * Sets the val value for this ProbeRange.
     * 
     * @param val
     */
    public void setVal(lu.hitec.pss.soap.sensor.client._15_x.ProbeValue[] val) {
        this.val = val;
    }

    public lu.hitec.pss.soap.sensor.client._15_x.ProbeValue getVal(int i) {
        return this.val[i];
    }

    public void setVal(int i, lu.hitec.pss.soap.sensor.client._15_x.ProbeValue _value) {
        this.val[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProbeRange)) return false;
        ProbeRange other = (ProbeRange) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProbeRange.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/sensor/client/15.x", "probeRange"));
