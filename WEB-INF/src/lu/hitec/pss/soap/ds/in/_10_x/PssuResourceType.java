...
public class PssuResourceType  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.ds.in._10_x.ResourcesTypesEnum type;
    ...
    public PssuResourceType(
           ...
           byte[] jpegPhoto,
           lu.hitec.pss.soap.ds.in._10_x.ResourcesTypesEnum type,
     ...
     * @return type
     */
    public lu.hitec.pss.soap.ds.in._10_x.ResourcesTypesEnum getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(lu.hitec.pss.soap.ds.in._10_x.ResourcesTypesEnum type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "pssuResourceType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "resourcesTypesEnum"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
