...
public class InternalId  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.ds.in._10_x.ServiceEnum service;
    ...
    public InternalId(
           ...
           lu.hitec.pss.soap.ds.in._10_x.ServiceEnum service) {
     ...
     * @return service
     */
    public lu.hitec.pss.soap.ds.in._10_x.ServiceEnum getService() {
        return service;
    }
     ...
     * @param service
     */
    public void setService(lu.hitec.pss.soap.ds.in._10_x.ServiceEnum service) {
        this.service = service;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "internalId"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "serviceEnum"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
