...
public class UnitId  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.ds.in._10_x.UnitType unitType;
    ...
    public UnitId(
           ...
           lu.hitec.pss.soap.ds.in._10_x.UnitType unitType) {
           this.uid = uid;
     ...
     * @return unitType
     */
    public lu.hitec.pss.soap.ds.in._10_x.UnitType getUnitType() {
        return unitType;
    }
     ...
     * @param unitType
     */
    public void setUnitType(lu.hitec.pss.soap.ds.in._10_x.UnitType unitType) {
        this.unitType = unitType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "unitId"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "unitType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
