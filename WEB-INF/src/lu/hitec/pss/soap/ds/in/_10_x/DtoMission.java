...
public class DtoMission  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.ds.in._10_x.WorkflowStatus workflowStatus;
    ...
    public DtoMission(
           ...
           lu.hitec.pss.soap.ds.in._10_x.WorkflowStatus workflowStatus,
           int zoomLevel) {
           this.area = area;
     ...
     */
    public lu.hitec.pss.soap.ds.in._10_x.WorkflowStatus getWorkflowStatus() {
        return workflowStatus;
    }
     ...
     */
    public void setWorkflowStatus(lu.hitec.pss.soap.ds.in._10_x.WorkflowStatus workflowStatus) {
        this.workflowStatus = workflowStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "dtoMission"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "workflowStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
