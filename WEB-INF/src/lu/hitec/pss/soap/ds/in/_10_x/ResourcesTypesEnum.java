...
public class ResourcesTypesEnum implements java.io.Serializable {
    ...
    public static final java.lang.String _FENCE_SEVERITY = "FENCE_SEVERITY";
    ...
    public static final java.lang.String _SPOKEN_LANGUAGE_LEVEL_TYPES = "SPOKEN_LANGUAGE_LEVEL_TYPES";
    public static final java.lang.String _SPOKEN_LANGUAGE_TYPES = "SPOKEN_LANGUAGE_TYPES";
    ...
    public static final ResourcesTypesEnum FENCE_SEVERITY = new ResourcesTypesEnum(_FENCE_SEVERITY);
    ...
    public static final ResourcesTypesEnum SPOKEN_LANGUAGE_LEVEL_TYPES = new ResourcesTypesEnum(_SPOKEN_LANGUAGE_LEVEL_TYPES);
    public static final ResourcesTypesEnum SPOKEN_LANGUAGE_TYPES = new ResourcesTypesEnum(_SPOKEN_LANGUAGE_TYPES);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/ds/in/10.x", "resourcesTypesEnum"));
    }
    /**
