...
public class NotifierFilter  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.event.client._25_x.Severity minSeverity;  // attribute
    ...
    public NotifierFilter(
           ...
           lu.hitec.pss.soap.event.client._25_x.Severity minSeverity,
     ...
     * @return minSeverity
     */
    public lu.hitec.pss.soap.event.client._25_x.Severity getMinSeverity() {
        return minSeverity;
    }
     ...
     * @param minSeverity
     */
    public void setMinSeverity(lu.hitec.pss.soap.event.client._25_x.Severity minSeverity) {
        this.minSeverity = minSeverity;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/client/25.x", "notifierFilter"));
