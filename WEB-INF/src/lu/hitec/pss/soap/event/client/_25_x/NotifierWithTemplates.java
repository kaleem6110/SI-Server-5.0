...
public class NotifierWithTemplates  implements java.io.Serializable {
    ...
    private lu.hitec.pss.soap.event.client._25_x.Notifier notifier;
    ...
    public NotifierWithTemplates(
           ...
           lu.hitec.pss.soap.event.client._25_x.Notifier notifier,
     ...
     * @return notifier
     */
    public lu.hitec.pss.soap.event.client._25_x.Notifier getNotifier() {
        return notifier;
    }
     ...
     * @param notifier
     */
    public void setNotifier(lu.hitec.pss.soap.event.client._25_x.Notifier notifier) {
        this.notifier = notifier;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/client/25.x", "notifierWithTemplates"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/client/25.x", "notifier"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
