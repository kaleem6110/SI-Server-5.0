...
public class Status implements java.io.Serializable {
    ...
    public static final Status ONGOING = new Status(_ONGOING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/client/25.x", "status"));
    }
    /**
