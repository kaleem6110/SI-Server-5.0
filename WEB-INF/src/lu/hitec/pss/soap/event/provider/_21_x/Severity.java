...
public class Severity implements java.io.Serializable {
    ...
    public static final Severity INFORMATION = new Severity(_INFORMATION);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/21.x", "severity"));
    }
    /**
