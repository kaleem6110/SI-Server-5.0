...
public class Recipient  implements java.io.Serializable {
    ...
    /**
     * Gets the userOrGroupUID value for this Recipient.
     * 
    ...
    /**
     * Sets the userOrGroupUID value for this Recipient.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hitec.lu/pss/soap/event/provider/21.x", "recipient"));
